...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        {
            if (element instanceof Apt1Room)
                ((Apt1Room) element).clean1Room();
            else if (element instanceof Apt2Room)
                ((Apt2Room) element).clean2Rooms();
            else if (element instanceof Apt3Room)
                ((Apt3Room) element).clean3Rooms();
        }
    }
